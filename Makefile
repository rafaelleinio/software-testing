...
tests:
	...
	@echo "=========="
	@echo ""
	@python -m pytest -W ignore::DeprecationWarning --cov-config=.coveragerc --cov-report term --cov-report html:unit-tests-cov --cov=software_testing --cov-fail-under=75 tests/
...
unit-tests:
	...
	@echo "=========="
	@echo ""
	@python -m pytest -W ignore::DeprecationWarning --cov-config=.coveragerc --cov-report term --cov-report html:unit-tests-cov --cov=software_testing --cov-fail-under=75 tests/unit
...
apply-style:
	...
	@python -m isort -rc software_testing/ tests/
...
clean:
	...
	@find ./ -type d -name 'software_testing.egg-info' -exec rm -rf {} +;
